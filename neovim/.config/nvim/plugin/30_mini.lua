...
later(function()
    ...
    miniclue.setup({
        ...
        clues = {
            ...
            -- Square bracket clues - automatically generates clues for mini.bracketed
            -- mappings like [b (previous buffer), ]d (next diagnostic), etc.
        ...
        -- Array modes feature: use arrays for mode to group multiple modes in one entry
        triggers = {
