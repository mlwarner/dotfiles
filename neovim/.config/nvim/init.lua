...
-- └────────────────────┘
--
-- This config is designed to mostly use MINI. It provides a stable, polished,
-- and feature rich Neovim experience. Config structure:
--
...
-- ├── ftplugin/       Files for filetype behavior
...
-- - Navigate existing buffers with `[b`, `]b`, or `<Space>,`.
--
